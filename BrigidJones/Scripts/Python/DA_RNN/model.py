...
class Encoder(nn.Module):
    """encoder in thesis.Models.DA_RNN."""

    def __init__(self, T,
                 input_size,
                 encoder_num_hidden,
                 parallel=False):
        """Initialize an encoder in thesis.Models.DA_RNN."""
        ...
        # Fig 1. Temporal Attention Mechanism: Encoder is thesis.Models.LSTM
    ...
    def forward(self, X):
        ...
        for t in range(self.T - 1):
            ...
            # get new input for thesis.Models.LSTM
...
class Decoder(nn.Module):
    """decoder in thesis.Models.DA_RNN."""

    def __init__(self, T, decoder_num_hidden, encoder_num_hidden):
        """Initialize a decoder in thesis.Models.DA_RNN."""
...
class DA_RNN(nn.Module):
    ...
    def __init__(self, X, y, T,
        ...
        # Training set
        self.train_timesteps = int(self.X.shape[0] * split)
